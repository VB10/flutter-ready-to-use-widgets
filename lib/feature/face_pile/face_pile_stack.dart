...
class FacePileStack extends StatelessWidget {
  final double width;
  ...
  double get frameWidth => amount * (width * offsetValue) + (width * (1 - offsetValue));

  List<Widget> generateFacePile(BuildContext context) {
    return List.generate(amount, (index) => generateAvatar(context, index));
  }
